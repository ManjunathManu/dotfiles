...
# tm_battery="#(~/Documents/projects/trial-projects/dotfiles/bin/battery_indicator.sh)"
# tm_battery="#[fg=$base0F,bg=$base00] ♥ #(battery)"
tm_battery="#[default,bg=$base00,fg=$base0C] Battery"
